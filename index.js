window.onload = function(){
    ...
    let buy_now;   let quantity; let items_in_cart;
   ...
   // console.log(featured_grid.innerHTML)
    ...
    function add_to_cart(){
        ...
        total_elm.textContent = calculateTotal() ;
         ...
         const  remove_elm = document.querySelectorAll(".remove");


        remove_elm.forEach(elm=> elm.addEventListener("click",remove_item_from_cart))

        const increase_quantity_elm =  document.querySelectorAll(".up_arrow");

        const decrease_quantity_elm =  document.querySelectorAll(".down_arrow");
    ...
    function calculateTotal(){
        let total;
            ...
            items_in_cart.forEach(function(elm,index){
                ...
                total += parseInt(this.querySelector(".cart_product_price")) * parseInt(this.querySelector(".quantity"))
